main();
//call api customTask(task = "AV_StrokeNumberGliter2", delay = 0, sender = -1, rounds = 3)
//see helperFunctions.js
//direct call will send only one line
function main(){
	DMessage("AV_StrokeNumberGliter2_First Task: Beginning");
	let answers = [ 
	...
	DMessage("AV_StrokeNumberGliter2_First Task: End");
	return;
}