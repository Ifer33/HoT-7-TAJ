...
function main(){
	DMessage("AV_CBT_Gliter3 Task: Beginning");
	let answers = [ 
    ...
    [null,"I want you to add 5 more %domFriend3Name% Smacks to each ball",null],
    [null,"Let\'s give those balls another 5 %domFriend3Name% Smacks %EmoteHappy%",null],
    [null,"Give yourself 10 good cock %domFriend3Name% Smacks %Grin%",null],
    [null,"Slap that %Cock% 5 times in a row",null],
    [null,"Swat that %Cock% with your palm a few times",null],
    [null,"Give yourself one good %domFriend3Name% Smack on the head of your cock %Grin%",null],
	...
	DMessage("AV_CBT_Gliter3 Task: End");
	return;
}