main();
//call api customTask(task = "AV_CBT_Gliter1", delay = 0, sender = -1, rounds = 3)
//see helperFunctions.js
//direct call will send only one line
function main(){
	DMessage("AV_CBT_Gliter1_First Task: Beginning");
	let answers = [ 
    [null,"I want you to add 5  ball Smacks to each ball",null],
	...
	DMessage("AV_CBT_Gliter1_First Task: End");
	return;
}