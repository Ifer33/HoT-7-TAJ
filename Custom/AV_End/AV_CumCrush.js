...
function main()
{
    ...
    CMessage(random("C\'mon baby, %Stroke% your cock for her ", "Faster, just look at this woman, doesn\'t she make you hot as hell? "));
	CMessage("%AV_CrushMemRnd%");
    sleep(randomInt(10, 20));
    CMessage("%KeepStroking%");
	CMessage("%AV_CrushMemRnd%");
    CMessage(random("You\'ve jerked so many times for her, you know it feels great ", "You are a man, so prove it to me! "));
	CMessage("%AV_CrushMemRnd%");
    CMessage(random("Doesn\'t she just want to make you squirt all over the place? ", "Look at her! Worship her beatiful body with your strokes "));
	CMessage("%AV_CrushMemRnd%");
    sleep(randomInt(10, 20));
    CMessage("%KeepStroking%");
	CMessage("%AV_CrushMemRnd%");
    CMessage(random("Yeah ", "she\'s pretty sexy ", "I can understand you wanting to wank for her ", "I guess she wouldn\'t mind you blowing your load for her. "));
	CMessage("%AV_CrushMemRnd%");
    CMessage(random("She is looking at you, you need to impress her with your fastest possible jerking! ", "Fast, faster, fastest! If you aren\'t almost edging while looking at her, I\'m not sure you are a man at all! "));
	CMessage("%AV_CrushMemRnd%");
    CMessage(random("You know you need it! All day and every day! %Stroke%! ", "%Stroking% is what you were made for, just admit it and give to her "));
	CMessage("%AV_CrushMemRnd%");
