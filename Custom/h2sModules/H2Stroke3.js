DMessage("H2Stroke3: start");
main();
DMessage("H2Stroke3: end");
function main()
{
    addContact(4);
...
function Harry_cum_pos2()
{
    ...
    let answer0 = getInput("%SubName% let me know when you\'re ready?", null, -1, true, 4);
    while (!(answer0.isLike("ready") || answer0.isLike("ok") || answer0.isLike("yes") || answer0.isLike("no")))
    {
        answer0 = getInput("try again", null, -1, true, 4);
    }
...
function Contact3_unit()
{
    ...
    let answer0 = getInput("But tell me, did you like the game?", null, -1, true, 4);
    ...
    let answer1 = getInput("Or you want to push your limits today?", null, -1, true, 4);
...
function Contact3_decision()
{
    ...
    let answer0 = getInput("Pleasure or pain?", null, -1, true, 4);
...
function Rocket_man3()
{
    ...
    SMessage("dripping edges to go for you %SubName%",-1,4);
...
function Edge_loop3()
{
    ...
    let answer0 = getInput("Do you need a break?", null, -1, true, 4);
    while (!(answer0.isLike("yes") || answer0.isLike("no")))
    {
        SMessage("Thats fine", -1, 4);
		break;
    }
...
function Loop_no_hold3()
{
    ...
    let answer0 = getInput("Wanna try some more?",null, -1, true, 4);
    while (!(answer0.isLike("yes") || answer0.isLike("no")))
    {
        SMessage("Thats fine", -1, 4);
		break;
    ...
    {
        SMessage("Ok then immediately stop stroking", -1,4);
        setRapidText(true);
        Break3();
        return;
    }
...
function Loop_no_hold13()
{
    ...
    let answer0 = getInput("Another one?",null, -1, true, 4);
    while (!(answer0.isLike("yes") || answer0.isLike("no")))
    {
        SMessage("Thats fine", -1, 4);
		break;
...
function Loop_no_hold23()
{
    ...
    let answer0 = getInput("One more possible?",null, -1, true, 4);
    while (!(answer0.isLike("yes") || answer0.isLike("no")))
    {
        SMessage("Thats fine", -1, 4);
		break;
...
function Loop_no_hold33()
{
    ...
    let answer0 = getInput("Can you give me one more edge baby?",null, -1, true, 4);
    while (!(answer0.isLike("yes") || answer0.isLike("no")))
    {
        SMessage("Thats fine", -1, 4);
		break;
...
function Loop_no_hold43()
{
    ...
    let answer0 = getInput("Looks like you need a break, dont you?",null, -1, true, 4);
    while (!(answer0.isLike("yes") || answer0.isLike("no")))
    {
        SMessage("Thats fine", -1, 4);
		break;
