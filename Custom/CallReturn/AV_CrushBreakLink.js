DMessage("AV_CrushBreakLink: start");
main();
DMessage("AV_CrushBreakLink: end");
function main()
{
...
function Putplug()
{
    ...
    CMessage("Unless I want to play with your ass in other ways %EmoteSmile%");
    Pausa2();
	return;
}
function Pausa2()
