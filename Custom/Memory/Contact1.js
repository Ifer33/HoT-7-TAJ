DMessage("Contact1: start");
main();
DMessage("Contact1: end");
function main()
{
    if(getVar("AV_MEM_Contact3", false) || getVar("AV_MEM_Contact2", false))
    {
        CMessage("You are thinking " + random("too much ", "a lot ") + "about my friends...let\'s focus here");
        NoDeal();
        return;
    }
    let answer0 = getInput("Do you want to call %domFriend1Name% to the chat?", 5);
...
function CheckM()
{
    ...
    setTempVar("AV_MEM_Contact1", true);
    NoDeal();
}
function NoDeal()
{
