DMessage("AV_Trivia2: start");
main();
DMessage("AV_Trivia2: end");
function main()
{
...
function P02()
{
    ...
    while (!(answer0.isLike("sex") || answer0.isLike("real sex") || answer0.isLike("masturbation") || answer0.isLike("stroking") || answer0.isLike("jerking")))
    {
        answer0 = getInput("sex or masturbation %SubName%?");
    }
    if (answer0.isLike("sex", "real sex"))
    {
