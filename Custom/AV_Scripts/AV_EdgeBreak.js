DMessage("AV_EdgeBreak: start");
main();
DMessage("AV_EdgeBreak: end");
function main()
{
    CMessage("Let\'s use this now...");
    CMessage("You will %Stroke% and edge for every crush you " + random("told me", "shared with me"));
    CMessage("After that, I will give you a few " + random("moments ", "minutes ") + "to recover.");
    CMessage("Looks fun, right? %EmoteLaugh%");
    CMessage("Let\'s " + random("begin ", "start ") + "with...");
    ...
    CMessage("Now I need to check your new crushes");
    CMessage("This can be a lot of edges for you %EmoteSmile%");
    CMessage("Ready?");
    ...
    {
        CMessage("Oh...no more crushes...");
        Decide_rest_time();
        return;
    }
    CMessage("Wow, that was " + random("intense ", "hot ", "harsh ") + "%Lol%");
    CMessage("But I know you love it");
    sleep(10);
    Decide_rest_time();
}
function Decide_rest_time()
{
    CMessage("Now you can rest");
    CMessage("I will give you...");
    switch(random("AVMin1", "AVMin2", "AVMin3", "AVMin4"))
    {
        case "AVMin1":
        AVMin1();
        return;
...
function AVMin1()
{
    CMessage("1 minute to " + random("recover ", "rest ") + "Enjoy");
    sleep(60);
    MissBack();
    return;
    AVMin2();
...
function AVMin2()
{
    CMessage("2 minutes to " + random("recover ", "rest ") + "Enjoy");
    sleep(120);
    MissBack();
    return;
    AVMin3();
...
function AVMin3()
{
    CMessage("3 minutes to " + random("recover ", "rest ") + "Enjoy");
    sleep(180);
    MissBack();
    return;
    AVMin4();
...
function AVMin4()
{
    CMessage("4 minutes to " + random("recover ", "rest ") + "Enjoy");
    sleep(240);
    MissBack();
}
function MissBack()
{
    CMessage("Enough rest %SubName%");
