DMessage("AV_GlitterBored: start");
main();
DMessage("AV_GlitterBored: end");
function main()
{
...
function a01()
{
    ...
    if (inGroup([1, 2]))
    {
        //--Command:RandomContact
		if(randomInt(1,100)<=50){
			send=2;
		}
        SMessage(random("Hey, what\'s going on ", "Hey you ", "Hey you guys and girls %Smile% ") + "%Smile%",-1,send);
    }
    if (inGroup([1, 3]))
    {
        //--Command:RandomContact
