DMessage("HoTSetup: start");
main();
DMessage("HoTSetup: end");
function main()
{
    ...
    CMessage("You will see some of the original Domme comments on your answers, because I did not edit that parts.");
    CMessage("If this is the first time ever you are running House of Tease, dont skip any question, same thing if you reseted all the variables and flags.");
	//@RTOff
    CMessage("First thing, we have 4 Crushes to select, Actress, Singer, PornStar and your Secret Crush.")
	//CMessage("First thing, <Font color="blue">we have 4 Crushes to select, Actress, Singer, PornStar and your Secret Crush.</Font>")
...
function a007()
{
    ...
    CMessage("All done");
    CMessage("You should not see that again, but sometimes I saw TeaseAI ignore a flag on the start and run what should not run.");
	//@RTOn
    CMessage("If this happens to you, just close TeaseAI when in this file and try again.");
    //CMessage("In the case you find any bugs on House of Tease, please first enter \"@\" on the chat, to see where is the bug");
    ...
    CMessage("and try to type your safeword after the cbt part.");
    CMessage("And remember to play safe...Dont do anything you think you should not.");
	unlockImages();
    endSession();
    return;
}