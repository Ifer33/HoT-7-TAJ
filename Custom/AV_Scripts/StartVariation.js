DMessage("StartVariation: start");
main();
DMessage("StartVariation: end");
function main()
{
	if (randomInteger(1, 100) <= 50)
    {
		CMessage("%AV_StartStrokes40%");
		switch(random("a01", "a02", "a05", "a06"))
		{
			case "a01":
			a01();
			return;
...
function help_it()
{
    CMessage("You just <i>have</i> to come back to me");
	if (randomInteger(1, 100) <= 50)
    {
