...
{
	if(inGroup(1) ){	//domme alone
		CustomizedMessage(message, delay, 1, null, null, showTyping);
	}else if(inGroup(2) ){
		CustomizedMessage(message, delay, 2, null, null, showTyping);
	}else if(inGroup(3) ){
		CustomizedMessage(message, delay, 3, null, null, showTyping);
	}else if(inGroup(4) ){
		CustomizedMessage(message, delay, 4, null, null, showTyping);
	}else {//more than 1 contactActive send as domme
		CustomizedMessage(message, delay, 1, null, null, showTyping);
	}
}
function SMessage(message, delay=-1, sender=-1)
{
	...
	else if(inGroup(1) ){	//domme alone
		CustomizedMessage(message, delay, 1, null, null, true);
	}else if(inGroup(2) ){
		CustomizedMessage(message, delay, 2, null, null, true);
	}else if(inGroup(3) ){
		CustomizedMessage(message, delay, 3, null, null, true);
	}else if(inGroup(4) ){
		CustomizedMessage(message, delay, 4, null, null, true);
	}else {//more than 1 contactActive send as domme
		CustomizedMessage(message, delay, sender, null, null, true);
	}
    //CustomizedMessage(message, delay, sender, null, null, true);
