DMessage("Extended_Start: start");
main();
DMessage("Extended_Start: end");
function main()
{
    CMessage("%GreetSub%");
...
function NormalStart()
{
    ...
    delVar("pvCollared");
    delVar("AV_Talk_Decided");
    delVar("AV_Talk_Pegging");
    delVar("AV_Talk_Humiliation");
    delVar("AV_Talk_Chastity");
    delVar("AV_Talk_Control");
    delVar("AV_Talk002_NotFirstTime");
    delVar("AV_Talk003_NotFirstTime");
    delVar("AV_Talk004_NotFirstTime");
    delVar("AV_Talk005_NotFirstTime");
    delVar("AV_AskedSlow");
    ...
    setTempVar("AV_TalkToday", true);
    NoTalkToday();
}
function NoTalkToday()
{
    if(getVar("AV_Warning", false))
    {
        SkipWarning();
        return;
    }
...
function SkipWarning()
{
    ...
    CMessage("I'll tell you to stop and you'll immediately stop");
    ...
    CMessage("I'm going to condition you to respond to the sounds of EDGE, STROKE and STOP.");
...
function SomeTimeSession()
{
    run("Custom" + java.io.File.separator + "AV_Start" + java.io.File.separator + "OrgasmCheck.js");
    SkipSomeTime();
	return;
}
function SkipSomeTime()
{
...
function start1_not_surprised()
{
    ...
    {
        CMessage("Good, I " + random("like it when you\'re all ", "want you ") + random("exposed ", "vulnerable ") + "%Smile%");
        Start_Stroking();
        return;
    }
...
function task9()
{
    ...
    CMessage("When you get close, stop and rest for 30 seconds, then right back to the edge.");
